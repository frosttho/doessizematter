...
posts <- read_delim("data/Instagram__Posts_corrected_Study2.tsv", delim = "\t", quote="", col_types = "ccnTccnnccccc")
...
write_csv(output, 'test_study2.html')
...
write_tsv(export, "data/Instagram__Posts_corrected_SiEBERT-input.tsv", na = "")
